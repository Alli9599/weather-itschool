function getDayOffTheWeek(utcDate) {
    // Pentru a crea o data dintr-o valoate utc trebuie sa o inmultim cu 1000
    ...
    switch(dayIndex) {
        ...
        case 6:
            ...
            break;
        default:
// afisam o eroare daca indexul nu este valid (nu ar trebui sa se ajunga aici deoarece OpenWeather intoarce zilele saptamanii corect)
